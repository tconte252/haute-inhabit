...
function twentyfifteen_setup() {
	...
	//set_post_thumbnail_size( 825, true );
...
function haute_widgets_init() {

	register_sidebar( array(
		'name' => __( 'Footer Subscribe', 'serveroid' ),
		'id' => 'sidebar-1',
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget' => "</aside>",
	...
	register_sidebar( array(
		'name' => __( 'Nav Subscribe', 'serveroid' ),
		'id' => 'sidebar-5',
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget' => "</aside>",
	) );
...
add_action( 'widgets_init', 'haute_widgets_init' );
...
function autoset_featured() {
    ...
    $already_has_thumb = has_post_thumbnail($post->ID);
        ...
        $attached_image = get_children( "post_parent=$post->ID&post_type=post&post_mime_type=image&numberposts=1" );
            if ($attached_image) {
