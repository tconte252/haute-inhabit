	 ...
	 function home_tab() {
		...
		$title = __( 'WordPress Media Tools' ); ?>
			...
			<form action="" method="get" id="export-filters">
				...
				<p><label><input type="radio" name="content" value="all" /> <?php _e( 'All content' ); ?></label></p>
				<p class="description"><?php _e( 'This will convert the first image from  all of your posts, pages, custom posts.' ); ?></p>

				<p><label><input type="radio" name="content" value="post" checked="checked"/> <?php _e( 'Posts' ); ?></label></p>
					<ul id="post-filters" class="export-filters">
						<li><label><?php _e( 'Categories:' ); ?></label><option value="460"><?php _e( 'Instagram' ) ;?></option><?php // wp_dropdown_categories( array ( 'show_option_all' => __( 'All' ) ) ); ?></li>
						...
						<li><label><?php _e( 'Date range:' ); ?></label>
							...
							<select name="post_end_date">
								<option value=""><?php _e( 'End Date' ); ?></option>
								<?php $this->convert_date_options(); ?>
							</select>
						</li>
