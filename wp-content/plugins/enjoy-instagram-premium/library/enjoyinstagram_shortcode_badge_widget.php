...
/*
echo $badge_username.'<br />'.$badge_bio.'<br />'.$badge_website.'<br />'.$badge_profile_image.'<br />'.$badge_full_name.'<br />'.$badge_number_images.'<br />'.$badge_followed_by.'<br />'.$badge_follows;
*/
